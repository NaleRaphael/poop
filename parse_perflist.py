...
HEADER = """/// This file is generated by "parse_perflist.py".
///
/// Remember to update or comment out any literal of which the `name` field is
/// filled with the placeholder "PLEASE_RENAME_THIS_WITHIN_16_CHARS".
/// (It's because we haven't come up with a good solution to dynamically adjust
/// the legth of measurement name)
///
/// Note that the field `full_name` will be used for matching with user query,
/// so please keep them as they are.
